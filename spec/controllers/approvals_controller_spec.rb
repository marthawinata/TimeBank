  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Approval" do
        expect {
          post :create, :approval => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested approval" do
        ...
        Approval.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => approval.id, :approval => {'these' => 'params'}
      end
    ...
    describe "with invalid params" do
      it "assigns the approval as @approval" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Approval.any_instance.stub(:save).and_return(false)
        put :update, :id => approval.id, :approval => {}
        assigns(:approval).should eq(approval)
      end
